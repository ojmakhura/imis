...
import { PolicyTypeEditorComponent } from './policy-type-editor.component';
import { TableComponent } from '@app/components/table/table.component';
import { PolicyTypeApiStore } from '@app/store/bw/co/roguesystems/imis/policy/type/policy-type-api.store';

@Component({
  selector: 'app-policy-type-editor',
  templateUrl: './policy-type-editor.component.html',
  styleUrls: [],
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule, TranslateModule, MaterialModule, CsvModule, TableComponent],
})
export class PolicyTypeEditorImplComponent extends PolicyTypeEditorComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      let policyType = this.policyTypeStore.data();

      if(policyType) {
        this.formGroupControl.patchValue(policyType);
      }
