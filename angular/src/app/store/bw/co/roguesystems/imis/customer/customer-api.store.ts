...
import { CustomerApi } from '@app/service/bw/co/roguesystems/imis/customer/customer-api';
...
export const CustomerApiStore = signalStore(
  { providedIn: 'root' },
  ...
  withMethods((store) => {
    ...
    return {
      ...
      save: rxMethod<{customer: CustomerVO | any }>(
        switchMap((data) => {
          patchState(store, { loading: true });
